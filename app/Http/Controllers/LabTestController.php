...
class LabTestController extends Controller
{
    ...
    //             if(Auth::user()->roles->contains(1)){
    //             $data = '';
    //             $data .= '<a href="'.route('lab-test.edit', $row->id).'?url=lab-test" class="btn btn-primary btn-sm mr-1">
    //                 <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
    //             </a>';

    //             $data .= '<form action="'.route('lab-test.destroy',$row->id).'" method="POST" style="display: inline-block;">
    ...
    //                 $data = '';
    //             $data .= '<a href="'.route('lab-test.edit', $row->id).'" class="btn btn-primary btn-sm">
    //                 <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
    //             </a>';
